...
export default function Page() {
	return (
		<div className="flex min-h-screen flex-col dark:bg-gray-950">
			{/* Navigation */}
			<nav className="fixed z-10 w-full border-b bg-white/50 backdrop-blur-xl dark:border-gray-800 dark:bg-gray-950/50">
					...
					<div className="flex h-16 justify-between">
						...
						<div className="flex items-center space-x-4">
							<Link
								...
								className="flex items-center rounded-lg px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
							>
							...
							<Link
								href="/login"
								className="rounded-lg px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
							>
								Sign In
							</Link>
							<Link
			...
			<main className="flex-grow">
				<div className="relative isolate">
					...
					>
						<div
							className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-blue-200 to-indigo-300 opacity-30 dark:from-blue-800 dark:to-indigo-900 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
							style={{
								clipPath:
					...
					<div className="mx-auto max-w-7xl px-6 pt-32 sm:pt-40 lg:px-8">
						<div className="lg:grid lg:grid-cols-12 lg:gap-x-8">
							<div className="lg:col-span-7">
								<div className="mb-6 flex w-fit items-center gap-2 rounded-full bg-blue-50 px-4 py-2 font-semibold text-blue-600 dark:bg-blue-950/50 dark:text-blue-400">
								...
								<div className="mt-10 flex items-center gap-x-6">
									<Link
										href="/register"
										className="flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-lg font-semibold text-white shadow-sm transition-colors hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600"
									>
										Start Building
									...
									<Link
										href="#stack"
										className="group flex items-center gap-1 text-lg font-semibold leading-6 text-gray-900 transition-colors hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400"
									>
										View Stack{" "}
										<span
								...
								<div className="mt-10 flex items-center gap-4 border-t border-gray-200 pt-8 dark:border-gray-800">
							...
							<div className="hidden lg:relative lg:col-span-5 lg:block">
								<div className="mt-8 rounded-2xl bg-gray-900/5 p-4 ring-1 ring-inset ring-gray-900/10 dark:bg-gray-800/30 dark:ring-gray-700 lg:rounded-3xl lg:p-8">
									<pre className="text-sm leading-6 text-gray-700 dark:text-gray-300">
...
export async function GET() {
  ...
  return NextResponse.json(records);
				...
				{/* Tech Stack Section */}
				<div id="stack" className="py-24 dark:bg-gray-950/50 sm:py-32">
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<div className="mx-auto max-w-2xl lg:text-center">
							<h2 className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-2 text-base font-semibold leading-7 text-blue-600 dark:bg-blue-950/50 dark:text-blue-400">
								<DatabaseIcon className="h-5 w-5" />
								Modern Tech Stack
							</h2>
							<p className="mt-6 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
						...
						<div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
							<dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
								{techStack.map((tech) => (
									<div
										key={tech.name}
										className="group flex flex-col rounded-3xl bg-white p-8 shadow-sm ring-1 ring-gray-200 transition-all duration-200 hover:ring-blue-500 dark:bg-gray-800 dark:ring-gray-700 dark:hover:ring-blue-500"
									>
										<dt className="flex items-center gap-x-3 text-lg font-semibold leading-7 text-gray-900 dark:text-white">
											<tech.icon
												className="h-7 w-7 flex-none text-blue-600 transition-transform duration-200 group-hover:scale-110 dark:text-blue-400"
												aria-hidden="true"
											/>
											{tech.name}
										</dt>
										<dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
											...
											<div className="mt-6 flex flex-wrap gap-2">
												{tech.features.map((feature) => (
													<span
														key={feature}
														className="inline-flex items-center rounded-full bg-blue-50 px-3 py-1 text-sm font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10 dark:bg-blue-950/50 dark:text-blue-300 dark:ring-blue-500/20"
													>
														{feature}
													</span>
												))}
				...
				{/* Features Section */}
				<div id="features" className="py-24 dark:bg-gray-950 sm:py-32">
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<div className="mx-auto max-w-2xl lg:text-center">
							<h2 className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-2 text-base font-semibold leading-7 text-blue-600 dark:bg-blue-950/50 dark:text-blue-400">
								<BoltIcon className="h-5 w-5" />
								...
								{features.map((feature) => (
									<div key={feature.name} className="relative pl-16">
										<dt className="text-base font-semibold leading-7 text-gray-900 dark:text-white">
											<div className="absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-600 dark:bg-blue-500">
												<feature.icon
				...
				<div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
					<div className="flex justify-center space-x-6 md:order-2">
						<Link
							...
							target="_blank"
							rel="noopener noreferrer"
							className="flex items-center gap-2 text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400"
						>
